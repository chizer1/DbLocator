import{o as oe}from"./chunk-KF4CENUX.min.js";import{K as Q,M as re,N as ie,Z as le,h as x,ia as B,j as se}from"./chunk-UOD6J27N.min.js";function ae(a){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];var s=Array.from(typeof a=="string"?[a]:a);s[s.length-1]=s[s.length-1].replace(/\r?\n([\t ]*)$/,"");var n=s.reduce(function(l,o){var p=o.match(/\n([\t ]+|(?!\s).)/g);return p?l.concat(p.map(function(c){var h,u;return(u=(h=c.match(/[\t ]/g))===null||h===void 0?void 0:h.length)!==null&&u!==void 0?u:0})):l},[]);if(n.length){var r=new RegExp(`
