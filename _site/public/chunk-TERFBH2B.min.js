...
`,type:re.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE}),I(r,Xi)||n.push({message:"A MultiMode Lexer cannot be initialized without a <"+Xi+`> property in its definition
`,type:re.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY}),I(r,Xi)&&I(r,Or)&&!I(r.modes,r.defaultMode)&&n.push({message:`A MultiMode Lexer cannot be initialized with a ${Or}: <${r.defaultMode}>which does not exist
`,type:re.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST}),I(r,Xi)&&k(r.modes,(i,s)=>{k(i,(a,o)=>{if($e(a))n.push({message:`A Lexer cannot be initialized using an undefined Token Type. Mode:<${s}> at index: <${o}>
`,type:re.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED});else if(I(a,"LONGER_ALT")){let l=pe(a.LONGER_ALT)?a.LONGER_ALT:[a.LONGER_ALT];k(l,c=>{!$e(c)&&!ie(i,c)&&n.push({message:`A MultiMode Lexer cannot be initialized with a longer_alt <${c.name}> on token <${a.name}> outside of mode <${s}>
`,type:re.MULTI_MODE_LEXER_LONGER_ALT_NOT_IN_CURRENT_MODE})})}})}),n}function Uc(r,e,t){let n=[],i=!1,s=gt(ue(te(r.modes))),a=Kt(s,l=>l[ar]===oe.NA),o=Vc(t);return e&&k(a,l=>{let c=jc(l,o);if(c!==!1){let f={message:qh(l,c),type:c.issue,tokenType:l};n.push(f)}else I(l,"LINE_BREAKS")?l.LINE_BREAKS===!0&&(i=!0):qi(o,l.PATTERN)&&(i=!0)}),e&&!i&&n.push({message:`Warning: No LINE_BREAKS Found.
	This Lexer has been defined to track line and column information,
	But none of the Token Types can be identified as matching a line terminator.
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#LINE_BREAKS 
	for details.`,type:re.NO_LINE_BREAKS_FLAGS}),n}function Gc(r){let e={},t=mt(r);return k(t,n=>{let i=r[n];if(pe(i))e[n]=[];else throw Error("non exhaustive match")}),e}function Bc(r){let e=r.PATTERN;if(Ze(e))return!1;if(it(e))return!0;if(I(e,"exec"))return!0;if(Se(e))return!1;throw Error("non exhaustive match")}function zh(r){return Se(r)&&r.length===1?r.charCodeAt(0):!1}var Wc={test:function(r){let e=r.length;for(let t=this.lastIndex;t<e;t++){let n=r.charCodeAt(t);if(n===10)return this.lastIndex=t+1,!0;if(n===13)return r.charCodeAt(t+1)===10?this.lastIndex=t+2:this.lastIndex=t+1,!0}return!1},lastIndex:0};function jc(r,e){if(I(r,"LINE_BREAKS"))return!1;if(Ze(r.PATTERN)){try{qi(e,r.PATTERN)}catch(t){return{issue:re.IDENTIFY_TERMINATOR,errMsg:t.message}}return!1}else{if(Se(r.PATTERN))return!1;if(Bc(r))return{issue:re.CUSTOM_LINE_BREAK};throw Error("non exhaustive match")}}function qh(r,e){if(e.issue===re.IDENTIFY_TERMINATOR)return`Warning: unable to identify line terminator usage in pattern.
...
`+l)}k(this.lexerDefinitionWarning,o=>{En(o.message)}),this.TRACE_INIT("Choosing sub-methods implementations",()=>{if(Po?(this.chopInput=Xs,this.match=this.matchWithTest):(this.updateLastIndex=ce,this.match=this.matchWithExec),s&&(this.handleModes=ce),this.trackStartLines===!1&&(this.computeNewColumn=Xs),this.trackEndLines===!1&&(this.updateTokenEndLineColumnLocation=ce),/full/i.test(this.config.positionTracking))this.createTokenInstance=this.createFullToken;else if(/onlyStart/i.test(this.config.positionTracking))this.createTokenInstance=this.createStartOnlyToken;else if(/onlyOffset/i.test(this.config.positionTracking))this.createTokenInstance=this.createOffsetOnlyToken;else throw Error(`Invalid <positionTracking> config option: "${this.config.positionTracking}"`);this.hasCustom?(this.addToken=this.addTokenUsingPush,this.handlePayload=this.handlePayloadWithCustom):(this.addToken=this.addTokenUsingMemberAccess,this.handlePayload=this.handlePayloadNoCustom)}),this.TRACE_INIT("Failed Optimization Warnings",()=>{let o=ae(this.canModeBeOptimized,(l,c,u)=>(c===!1&&l.push(u),l),[]);if(t.ensureOptimizations&&!b(o))throw Error(`Lexer Modes: < ${o.join(", ")} > cannot be optimized.
	 Disable the "ensureOptimizations" lexer config flag to silently ignore this and run the lexer in an un-optimized mode.
	 Or inspect the console log for details on how to resolve these issues.`)}),this.TRACE_INIT("clearRegExpParserCache",()=>{wc()}),this.TRACE_INIT("toFastProperties",()=>{vn(this)})})}tokenize(e,t=this.defaultMode){if(!b(this.lexerDefinitionErrors)){let i=R(this.lexerDefinitionErrors,s=>s.message).join(`-----------------------
`);throw new Error(`Unable to Tokenize because Errors detected in definition of Lexer:
`+i)}return this.tokenizeInternal(e,t)}tokenizeInternal(e,t){let n,i,s,a,o,l,c,u,f,h,d,m,y,v,x,E,T=e,$=T.length,P=0,Te=0,xr=this.hasCustom?0:Math.floor(e.length/10),Ae=new Array(xr),wt=[],dt=this.trackStartLines?1:void 0,A=this.trackStartLines?1:void 0,g=Gc(this.emptyGroups),S=this.trackStartLines,N=this.config.lineTerminatorsPattern,j=0,O=[],L=[],we=[],Le=[];Object.freeze(Le);let Z;function Bt(){return O}function Ql(ve){let qe=lt(ve),Rr=L[qe];return Rr===void 0?Le:Rr}let Gd=ve=>{if(we.length===1&&ve.tokenType.PUSH_MODE===void 0){let qe=this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(ve);wt.push({offset:ve.startOffset,line:ve.startLine,column:ve.startColumn,length:ve.image.length,message:qe})}else{we.pop();let qe=yt(we);O=this.patternIdxToConfig[qe],L=this.charCodeToPatternIdxToConfig[qe],j=O.length;let Rr=this.canModeBeOptimized[qe]&&this.config.safeMode===!1;L&&Rr?Z=Ql:Z=Bt}};function Zl(ve){we.push(ve),L=this.charCodeToPatternIdxToConfig[ve],O=this.patternIdxToConfig[ve],j=O.length,j=O.length;let qe=this.canModeBeOptimized[ve]&&this.config.safeMode===!1;L&&qe?Z=Ql:Z=Bt}Zl.call(this,t);let Qe,ec=this.config.recoveryEnabled;for(;P<$;){l=null;let ve=T.charCodeAt(P),qe=Z(ve),Rr=qe.length;for(n=0;n<Rr;n++){Qe=qe[n];let We=Qe.pattern;c=null;let ht=Qe.short;if(ht!==!1?ve===ht&&(l=We):Qe.isCustom===!0?(E=We.exec(T,P,Ae,g),E!==null?(l=E[0],E.payload!==void 0&&(c=E.payload)):l=null):(this.updateLastIndex(We,P),l=this.match(We,e,P)),l!==null){if(o=Qe.longerAlt,o!==void 0){let Lt=o.length;for(s=0;s<Lt;s++){let pt=O[o[s]],Wt=pt.pattern;if(u=null,pt.isCustom===!0?(E=Wt.exec(T,P,Ae,g),E!==null?(a=E[0],E.payload!==void 0&&(u=E.payload)):a=null):(this.updateLastIndex(Wt,P),a=this.match(Wt,e,P)),a&&a.length>l.length){l=a,c=u,Qe=pt;break}}}break}}if(l!==null){if(f=l.length,h=Qe.group,h!==void 0&&(d=Qe.tokenTypeIdx,m=this.createTokenInstance(l,P,d,Qe.tokenType,dt,A,f),this.handlePayload(m,c),h===!1?Te=this.addToken(Ae,Te,m):g[h].push(m)),e=this.chopInput(e,f),P=P+f,A=this.computeNewColumn(A,f),S===!0&&Qe.canLineTerminator===!0){let We=0,ht,Lt;N.lastIndex=0;do ht=N.test(l),ht===!0&&(Lt=N.lastIndex-1,We++);while(ht===!0);We!==0&&(dt=dt+We,A=f-Lt,this.updateTokenEndLineColumnLocation(m,h,Lt,We,dt,A,f))}this.handleModes(Qe,Gd,Zl,m)}else{let We=P,ht=dt,Lt=A,pt=ec===!1;for(;pt===!1&&P<$;)for(e=this.chopInput(e,1),P++,i=0;i<j;i++){let Wt=O[i],qs=Wt.pattern,tc=Wt.short;if(tc!==!1?T.charCodeAt(P)===tc&&(pt=!0):Wt.isCustom===!0?pt=qs.exec(T,P,Ae,g)!==null:(this.updateLastIndex(qs,P),pt=qs.exec(e)!==null),pt===!0)break}if(y=P-We,A=this.computeNewColumn(A,y),x=this.config.errorMessageProvider.buildUnexpectedCharactersMessage(T,We,y,ht,Lt),wt.push({offset:We,line:ht,column:Lt,length:y,message:x}),ec===!1)break}}return this.hasCustom||(Ae.length=Te),{tokens:Ae,groups:g,errors:wt}}handleModes(e,t,n,i){if(e.pop===!0){let s=e.push;t(i),s!==void 0&&n.call(this,s)}else e.push!==void 0&&n.call(this,e.push)}chopInput(e,t){return e.substring(t)}updateLastIndex(e,t){e.lastIndex=t}updateTokenEndLineColumnLocation(e,t,n,i,s,a,o){let l,c;t!==void 0&&(l=n===o-1,c=l?-1:0,i===1&&l===!0||(e.endLine=s+c,e.endColumn=a-1+-c))}computeNewColumn(e,t){return e+t}createOffsetOnlyToken(e,t,n,i){return{image:e,startOffset:t,tokenTypeIdx:n,tokenType:i}}createStartOnlyToken(e,t,n,i,s,a){return{image:e,startOffset:t,startLine:s,startColumn:a,tokenTypeIdx:n,tokenType:i}}createFullToken(e,t,n,i,s,a,o){return{image:e,startOffset:t,endOffset:t+o-1,startLine:s,endLine:s,startColumn:a,endColumn:a+o-1,tokenTypeIdx:n,tokenType:i}}addTokenUsingPush(e,t,n){return e.push(n),t}addTokenUsingMemberAccess(e,t,n){return e[t]=n,t++,t}handlePayloadNoCustom(e,t){}handlePayloadWithCustom(e,t){t!==null&&(e.payload=t)}matchWithTest(e,t,n){return e.test(t)===!0?t.substring(n,e.lastIndex):null}matchWithExec(e,t){let n=e.exec(t);return n!==null?n[0]:null}};oe.SKIPPED="This marks a skipped Token pattern, this means each token identified by it willbe consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.";oe.NA=/NOT_APPLICABLE/;function It(r){return Do(r)?r.LABEL:r.name}function Do(r){return Se(r.LABEL)&&r.LABEL!==""}var rp="parent",Yc="categories",Jc="label",Qc="group",Zc="push_mode",eu="pop_mode",tu="longer_alt",ru="line_breaks",nu="start_chars_hint";function Ji(r){return np(r)}function np(r){let e=r.pattern,t={};if(t.name=r.name,$e(e)||(t.PATTERN=e),I(r,rp))throw`The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;return I(r,Yc)&&(t.CATEGORIES=r[Yc]),kt([t]),I(r,Jc)&&(t.LABEL=r[Jc]),I(r,Qc)&&(t.GROUP=r[Qc]),I(r,eu)&&(t.POP_MODE=r[eu]),I(r,Zc)&&(t.PUSH_MODE=r[Zc]),I(r,tu)&&(t.LONGER_ALT=r[tu]),I(r,ru)&&(t.LINE_BREAKS=r[ru]),I(r,nu)&&(t.START_CHARS_HINT=r[nu]),t}var ze=Ji({name:"EOF",pattern:oe.NA});kt([ze]);function or(r,e,t,n,i,s,a,o){return{image:e,startOffset:t,endOffset:n,startLine:i,endLine:s,startColumn:a,endColumn:o,tokenTypeIdx:r.tokenTypeIdx,tokenType:r}}function Nn(r,e){return vt(r,e)}var Nt={buildMismatchTokenMessage({expected:r,actual:e,previous:t,ruleName:n}){return`Expecting ${Do(r)?`--> ${It(r)} <--`:`token of type --> ${r.name} <--`} but found --> '${e.image}' <--`},buildNotAllInputParsedMessage({firstRedundant:r,ruleName:e}){return"Redundant input, expecting EOF but found: "+r.image},buildNoViableAltMessage({expectedPathsPerAlt:r,actual:e,previous:t,customUserDescription:n,ruleName:i}){let s="Expecting: ",o=`
...
but found: '`+Ie(e).image+"'";if(t)return i+t+a;{let l=`expecting at least one iteration which starts with one of these possible Token sequences::
  <${R(r,c=>`[${R(c,u=>It(u)).join(",")}]`).join(" ,")}>`;return i+l+a}}};Object.freeze(Nt);var iu={buildRuleNotFoundError(r,e){return"Invalid grammar, reference to a rule which is not defined: ->"+e.nonTerminalName+`<-
