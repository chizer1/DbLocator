        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatabaseRoleName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DatabaseServerID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DatabaseServerName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    DatabaseServerHostName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    DatabaseServerIPAddress = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    DatabaseServerFullyQualifiedDomainName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DatabaseTypeID = table.Column<byte>(type: "tinyint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DatabaseTypeName = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TenantID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    TenantCode = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DatabaseID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DatabaseName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    DatabaseServerID = table.Column<int>(type: "int", nullable: false),
                    DatabaseTypeID = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DatabaseUserRole", x => new { x.DatabaseUserID, x.DatabaseRoleID });
                    table.ForeignKey(
                        name: "FK_DatabaseUserRole_DatabaseRole_DatabaseRoleID",
                        column: x => x.DatabaseRoleID,
                        principalTable: "DatabaseRole",
                        principalColumn: "DatabaseRoleID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DatabaseUserRole_DatabaseUser_DatabaseUserID",
