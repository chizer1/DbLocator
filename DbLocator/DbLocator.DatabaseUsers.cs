...
public partial class Locator
{
    ...
    /// </param>
    /// <returns>
    /// The ID of the newly Createed database user.
    /// </returns>
    ...
    /// <summary>
    /// Creates a new database user with the specified database ID, user name, and the option to create the user.
    ...
    /// <summary>
    /// Creates a new database user with the specified database ID, user name, and user password.
    ...
    /// <summary>
    /// Creates a new database user with the specified database ID and user name.
