...
public partial class Locator
{
    ...
    /// </param>
    /// <returns>
    /// The ID of the newly Createed database.
    /// </returns>
    /// <exception cref="KeyNotFoundException">
    /// Thrown when the specified database server or database type is not found.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Thrown when the database name is invalid or when attempting to create a database with invalid parameters. The parameter name is included.
    /// </exception>
    ...
    /// <summary>
    /// Creates a new database with an option to create the database.
    /// </summary>
    /// <param name="databaseName">
    /// The name of the database.
    /// </param>
    ...
    /// </summary>
    /// <param name="databaseName">The name of the database to be Createed.</param>
