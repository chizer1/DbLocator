...
{
    /// <summary>
    /// Creates a new role to a database user. This method also updates the user if specified.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new role to a database user. This method does not update the user.
    /// </summary>
    /// <param name="databaseUserId">
    /// The ID of the database user to which the role will be assigned.
    /// </param>
