...
public class DatabaseUserTests
{
    ...
    [Fact]
    public async Task AddDatabaseUser_WithAutoGeneratedPassword_Succeeds()
    {
        // Arrange
        var userName = TestHelpers.GetRandomString();
        ...
        Assert.Single(user.Databases);
        Assert.Equal(_databaseId, user.Databases[0].Id);
    }

    [Fact]
    public async Task AddDatabaseUser_WithPasswordNoCreateFlag_Succeeds()
    {
        // Arrange
        var userName = TestHelpers.GetRandomString();
        ...
        // Act
        var userId = await _dbLocator.AddDatabaseUser([_databaseId], userName, password);
    ...
    [Fact]
    public async Task AddDatabaseUser_WithCreateFlagAutoPassword_Succeeds()
    {
        // Arrange
        var userName = TestHelpers.GetRandomString();

        // Act
        var userId = await _dbLocator.AddDatabaseUser([_databaseId], userName, true);
    ...
    [Fact]
    public async Task UpdateDatabaseUser_WithAutoGeneratedPassword_Succeeds()
    {
        // Arrange
        var originalUser = await AddDatabaseUserAsync(TestHelpers.GetRandomString());
        var newName = TestHelpers.GetRandomString();

        // Act
        await _dbLocator.UpdateDatabaseUser(originalUser.Id, [_databaseId], newName, true);

        // Assert
        var updatedUser = await _dbLocator.GetDatabaseUser(originalUser.Id);
        Assert.Equal(newName, updatedUser.Name);
    ...
    [Fact]
    public async Task UpdateDatabaseUser_WithoutUpdateFlag_Succeeds()
    {
        // Arrange
        var originalUser = await AddDatabaseUserAsync(TestHelpers.GetRandomString());
        var newName = TestHelpers.GetRandomString();
        ...
        // Act
        await _dbLocator.UpdateDatabaseUser(originalUser.Id, [_databaseId], newName, newPassword);
    ...
    [Fact]
    public async Task UpdateDatabaseUser_WithMinimalParameters_Succeeds()
    {
        // Arrange
        var originalUser = await AddDatabaseUserAsync(TestHelpers.GetRandomString());
        var newName = TestHelpers.GetRandomString();
        ...
        // Act
        await _dbLocator.UpdateDatabaseUser(originalUser.Id, [_databaseId], newName);
    ...
    [Fact]
    public async Task UpdateDatabaseUser_WithMultipleDatabases_Succeeds()
    {
        // Arrange
        var originalUser = await AddDatabaseUserAsync(TestHelpers.GetRandomString());
